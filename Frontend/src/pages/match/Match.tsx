    ...
    <AlertNotificationRoot>
              ...
              onPress={() => {
                ...
                if (!toggledSuccessfully) {
                  Dialog.show({
                    ...
                    title:
                      'You need to have premium account to use this feature',
                  });
                }
              }}>
      ...
      <RBSheet
        ...
        <View style={styles.detailContainer}>
          <Text style={[styles.detailTitle, {fontSize: 33, marginLeft: '5%'}]}>
            {currentData.name}
          </Text>
          <Image
            style={styles.profilePict}
            source={{uri: currentData.picture}}
          />
          <Text
            style={[
              styles.detailTitle,
              {fontSize: 25},
            ]}>{`${currentData.name.substring(0, 10)}, ${
            currentData.age
          }`}</Text>
          <Text
            style={[
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonTitle}>
              {show == 'match' ? 'Chat now !' : 'Add to match'}
            </Text>
          </TouchableOpacity>
        </View>
      </RBSheet>
