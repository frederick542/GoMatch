...
export default function FilterModal({
  ...
  function handleConfirmUpdateFilter() {
    setFilter({gender, minAge, maxAge, offset: 0});
    setFilterModalOpen(false);
  }
  ...
  return (
    <ModalWrapper handleCloseModal={handleCloseModal}>
      <>
        ...
        <Text style={styles.subtitleText}>Interested in</Text>
            ...
            return genderOption.toLowerCase() === gender.toLowerCase() ? (
              <CustomButton
                ...
                style={[
                  ...
                  styles.genderToggleButtonActive,
                ]}>
                <Text
                  style={[
              ...
              <CustomButton
                ...
                <Text style={styles.genderToggleText}>{genderOption}</Text>
              </CustomButton>
            );
          })}
        </View>
        ...
        <CustomButton
          ...
          onPress={handleConfirmUpdateFilter}>
